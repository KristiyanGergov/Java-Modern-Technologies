...
public class Task extends Issue {
    public Task(IssuePriority priority, Component component, User reporter, String description) throws InvalidReporterException, InvalidComponentException, InvalidDescriptionException, InvalidPriorityException {
