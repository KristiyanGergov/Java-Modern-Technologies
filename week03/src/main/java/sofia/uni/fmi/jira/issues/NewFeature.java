...
public class NewFeature extends Issue {
    ...
    public NewFeature(IssuePriority priority, Component component, User reporter, String description) throws InvalidReporterException, InvalidComponentException, InvalidDescriptionException, InvalidPriorityException {
